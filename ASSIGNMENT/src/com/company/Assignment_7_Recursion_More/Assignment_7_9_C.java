...
public class Assignment_7_9_C {
    ...
    private static StringBuilder dupi(StringBuilder processed,String unprocessed, int length, int count) {
        ...
        if (unprocessed.length()>=3&&unprocessed.charAt(0)=='h'&& unprocessed.charAt(1)=='i'&& unprocessed.charAt(2)=='t'){

            unprocessed=unprocessed.substring(3);
        }
          else  if (unprocessed.charAt(0)=='h'&& unprocessed.charAt(1)=='i'){
